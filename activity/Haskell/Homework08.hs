...
castiglioni :: Label
castiglioni = Label { grapes = ["Sangiovese"], region = ("Italy", "Tuscany"), kind   = Red 12.5 }
...
lePetitHautLafitte = Label { grapes = ["Cabernet-sauvignon", "Merlot"], region = ("France", "Bordeaux"), kind   = Red 13.5 }
